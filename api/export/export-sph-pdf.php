...
$content = '<!DOCTYPE html>
  ...
  <body>
    ...
    <table style="margin-top:30px;">
      <tr>
        <td colspan="2">
          <h3 class="title-print">SPH</h3></td>
      </tr>
      <tr>
...
$filename = str_replace("/","-",$dataMaster->NoSPH);
$mpdf->WriteHTML($content);
$mpdf->Output('SPH-'.$filename.'.pdf','F');
$file =  "SPH-".$filename.".pdf";
