...
$sql = "UPDATE tb_work_schedule SET Tipe='$tipe', RefID='$spb', IDPelanggan='$pelanggan', IDKaryawan='$karyawan', IDsKaryawan='$karyawan_ids', Tanggal='$tanggal', Judul='$judul', Keterangan='$keterangan', Status='$status', ModifiedBy='" . $_SESSION["uid"] . "', DateModified=NOW(), JenisUnit='$jenis_unit', PICPelanggan='$pic_pelanggan', NoTangki='$no_tangki', NoPanelA='$no_panel_a', NoPanelB='$no_panel_b', NoPanelC='$no_panel_c', NoTangkiHeatpump='$no_tangki_heatpump', NoOutdoorHeatpump='$no_outdoor_heatpump' WHERE IDWorkSchedule='$id'";
