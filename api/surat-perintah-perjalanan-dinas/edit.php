...
$query = $db->query("UPDATE tb_surat_perintah_perjalanan_dinas SET Tanggal='$tanggal', IDKaryawan='$karyawan', NamaPerusahaan='$nama_perusahaan', Alamat='$alamat', Telp='$no_telp', RencanaTugas='$rencana_tugas', TanggalMulai='$tgl_mulai', TanggalAkhir='$tgl_akhir', JamMulai='$jam_mulai', JamAkhir='$jam_akhir', Catatan='$catatan', Status='$statusspk', CreatedBy='$iduser' WHERE IDSPPD='$id'");
if($query){
    echo "1";
} else {
    echo "0";
