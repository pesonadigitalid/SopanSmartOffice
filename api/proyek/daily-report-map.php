...
$lat = antiSQLInjection($_GET['lat']);
$lng = antiSQLInjection($_GET['lng']);
?>
<!DOCTYPE html>
<html>
...
<body class="fixed-header no-header">
  ...
  <script src="../../themes/pages/js/pages.min.js"></script>
    <script type="text/javascript" src="http://maps.google.com/maps/api/js?v=3&sensor=false&key=AIzaSyB51KYsnGahkUFSmPoqjI18qCiOE6B3VQU"></script>
...
var map;
    $(document).ready(function(){
      ...
      map.addMarker({
        lat: <?php echo $lat; ?>,
        lng: <?php echo $lng; ?>,
        title: 'Lokasi Sending Report',
        infoWindow: {
          content: `Lokasi Sending Report`
        }
      });
    });
</script>
