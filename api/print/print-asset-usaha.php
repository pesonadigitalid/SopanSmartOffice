...
<body>
    ...
    <div class="laporanTitle">
        <h1 class="underline">** LAPORAN ASSET IJIN USAHA **</h1><?php echo $subtitle; ?>
    </div>
    <table class="tabelList2" cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php
            $query = newQuery("get_results", "SELECT *, DATE_FORMAT(JatuhTempoUsaha,'%d/%m/%Y') AS JatuhTempoUsahaID FROM tb_asset WHERE Jenis='Ijin-Usaha' $cond ORDER BY IDAsset ASC");
            if ($query) {
                $i = 1;
            ...
            ?>
                    <tr>
                        ...
                        <td><?php echo $data->NoIjinUsaha; ?></td>
                        <td><?php echo $data->JatuhTempoUsahaID; ?></td>
