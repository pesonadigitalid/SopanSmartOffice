...
$t = $dataSlip->GajiTahun;
$b = $dataSlip->GajiBulan;
$k = $dataSlip->IDKaryawan;
if ($b < 10) $b = "0" . $b;
$absen->calcHolidayWithoutSunday($t);
$totalHariKerjaBulan = $absen->getTotalHariKerjaBulanan($t, $b);
$totalHariKerja = $absen->getTotalHariKerjaBulanKaryawan($t, $b, $k);
?>
<!DOCTYPE html>
<html>
    ...
    <table>
        <tr>
            ...
            <td width="40%" class="center">
                <h1 class="underline" style="font-size: 16px !important">** SLIP GAJI **</h1>Periode : <?php echo $bulan[$dataSlip->GajiBulan] . " " . $dataSlip->GajiTahun; ?>
            </td>
            <td width="30%">
    ...
    <table class="tabelList3" cellpadding="0" cellspacing="0" style="margin-top:10px;margin-bottom:10px">
        <tr>
            <td width="50%">
                ...
                <label>Hari Kerja Sebulan </label>: <?php echo $totalHariKerjaBulan; ?> Hari
            </td>
            <td width="50%">
    ...
    <table class="tabelList4" cellpadding="0" cellspacing="0" style="margin-top:10px;margin-bottom:10px">
        <tr>
            <td width="50%" rowspan="2">
                ...
                <label>3. Uang Transport </label>: &nbsp;&nbsp;Rp. <?php echo number_format($dataSlip->UangTransport, 0); ?><br />
                <label>4. Uang Pulsa </label>: &nbsp;&nbsp;Rp. <?php echo number_format($dataSlip->UangPulsa, 0); ?><br />
                <label>5. Tunjangan Jabatan </label>: &nbsp;&nbsp;Rp. <?php echo number_format($dataSlip->UangTunjanganPerformance, 0); ?><br />
                <label>6. Tunjangan Khusus </label>: &nbsp;&nbsp;Rp. <?php echo number_format($dataSlip->UangTunjanganKhusus, 0); ?><br />
                <label>7. Tunjangan Luar Kota </label>: &nbsp;&nbsp;Rp. <?php echo number_format($dataSlip->UangTunjanganLuarKota, 0); ?><br />
                <label>8. Uang Lembur </label>: &nbsp;&nbsp;Rp. <?php echo number_format($dataSlip->UangLembur, 0); ?><br />
                <label>9. Uang Makan Lembur </label>: &nbsp;&nbsp;Rp. <?php echo number_format($dataSlip->UangMakanLembur, 0); ?><br /><br />
            ...
            <td width="50%" colspan="2">
                ...
                <label>1. Potongan Cuti </label>: &nbsp;&nbsp;Rp. <?php echo number_format($dataSlip->PotonganCutiMinus, 0); ?><br />
                <label>2. Potongan Alpha </label>: &nbsp;&nbsp;Rp. <?php echo number_format($dataSlip->PotonganAlpha, 0); ?><br />
                <label>3. Potongan Pinjaman </label>: &nbsp;&nbsp;Rp. <?php echo number_format($dataSlip->PotonganPinjaman, 0); ?><br />
                <label>4. Potongan Kasbon </label>: &nbsp;&nbsp;Rp. <?php echo number_format($dataSlip->PotonganKasbon, 0); ?><br />
                <label>5. Potongan Jamsostek </label>: &nbsp;&nbsp;Rp. <?php echo number_format($dataSlip->PotonganJamsostek, 0); ?><br />
                <label>6. Potongan Lain-lain </label>: &nbsp;&nbsp;Rp. <?php echo number_format($dataSlip->PotonganLainLain, 0); ?><br />
        ...
        <tr>
            ...
            <td width="25%" class="center" style="vertical-align: middle;">HRD,<br /><br /><br /><br />( Sumyartini )
            </td>
        </tr>
    </table>
