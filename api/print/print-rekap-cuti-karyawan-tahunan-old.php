...
<body class="center">
    ...
    <table class="tabelList6 border-solid" cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                foreach ($bulan as $key => $value) {
                    echo "<th width='30' colspan='4' class='center'>" . substr($value, 0, 3) . "</th>";
                }
                ?>
                <th width="10" colspan="4">Total</th>
            </tr>
            <tr>
                <?php
                foreach ($bulan as $key => $value) {
                    echo "<td width='30' class='center'>C</td>";
                    echo "<td width='30' class='center'>S</td>";
                    echo "<td width='30' class='center'>A</td>";
                    echo "<td width='30' class='center'>SS</td>";
                }
                ?>
                <th width="10">C</th>
                <th width="10">S</th>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    <td colspan="54" style="text-align: left"><strong>Lintas Daya</strong></td>
                </tr>
                <?php
                ...
                ?>
                    ...
                    ?>
                        <tr>
                            <td colspan="54" style="height: 15px;text-align: left"></td>
                        </tr>
                <?php
                    }
                    $num++;
            ...
            if ($query) {
                ...
                ?>
                <tr>
                    <td colspan="54" style="height: 15px;"></td>
                </tr>
                <tr>
                    <td colspan="54" style="text-align: left"><strong>MMS</strong></td>
                </tr>
                <?php
                foreach ($query as $data) {
                    $karyawan = $data->IDKaryawan;
            ...
            if ($query) {
                ...
                <tr>
                    <td colspan="54" style="text-align: left"><strong>Karyawan Harian</strong></td>
                </tr>
                <?php
                foreach ($query as $data) {
                    $karyawan = $data->IDKaryawan;
