...
$id = $_GET['id'];
$hideDiskon = $_GET['hideDiskon'];

$isHideDiskon = $hideDiskon == "1";
$colspan = $isHideDiskon ? "5" : "7";

$bulan = array("01" => "Januari", "02" => "Februari", "03" => "Maret", "04" => "April", "05" => "Mei", "06" => "Juni", "07" => "Juli", "08" => "Agustus", "09" => "September", "10" => "Oktober", "11" => "November", "12" => "Desember");
$dataPO = newQuery("get_row", "SELECT *, DATE_FORMAT(Tanggal,'%d/%m/%Y') AS TanggalID FROM tb_po WHERE NoPo='" . $id . "'");
$dataPenjualan = newQuery("get_row", "SELECT * FROM tb_penjualan WHERE IDPenjualan='" . $dataPO->IDPenjualan . "'");
...
<head>
    ...
    <title>Lintas Daya Smart Office - Integrated System</title>
...
<body>
    ...
    <table style="margin-top:30px;">
        <tr>
            <td colspan="2">
                <h3 class="title-print">PURCHASE ORDER</h3>
            </td>
        </tr>
        <tr>
            ...
            <td width="50%" align="right" style="padding-top: 20px !important;">
                ...
                <div class="sideText">
                    ...
                    <span><?php if ($dataPenjualan) echo $dataPenjualan->NoPenjualan;
                            else echo "-"; ?></span><br />
    ...
    <table class="tabelList2 border-solid" cellpadding="0" cellspacing="0" style="margin-top: 40px;">
        <thead>
            <tr>
                ...
                <th>Nama Barang</th>
                <?php if (!$isHideDiskon) { ?>
                    <th width="80">Harga Publish</th>
                    <th width="70">Diskon</th>
                <?php } ?>
        ...
        <tbody>
            ...
            ?>
                    <tr class="border-bottom">
                        ...
                        <?php if (!$isHideDiskon) { ?>
                            <td style="text-align: right;"><?php echo number_format($data->HargaPublish); ?></td>
                            <td style="text-align: right;"><?php echo $data->Diskon; ?></td>
                        <?php } ?>
            ...
            ?>
            <tr>
                <td colspan="<?php echo $colspan; ?>" style="text-align: right;"><strong>SUB TOTAL</strong></td>
                <td style="text-align: right;"><?php echo number_format($dataPO->Total); ?></td>
            </tr>
            <tr>
                <td colspan="<?php echo $colspan; ?>" style="text-align: right;"><strong>DISKON <?php if ($dataPO->DiskonPersen > 0) echo number_format($dataPO->DiskonPersen) . "%"; ?></strong></td>
                <td style="text-align: right;"><?php echo number_format($dataPO->Diskon); ?></td>
            </tr>
            <tr>
                <td colspan="<?php echo $colspan; ?>" style="text-align: right;"><strong>TOTAL</strong></td>
                <td style="text-align: right;"><?php echo number_format($dataPO->Total2); ?></td>
            </tr>
            <?php if ($dataPO->DPP > 0) { ?>
                <tr>
                    <td colspan="<?php echo $colspan; ?>" style="text-align: right;"><strong>DPP</strong></td>
                    <td style="text-align: right;"><?php echo number_format($dataPO->DPP); ?></td>
                </tr>
            <?php } ?>
            <?php if ($dataPO->PPNPersen > 0) { ?>
                <tr>
                    <td colspan="<?php echo $colspan; ?>" style="text-align: right;"><strong>PPN <?php if ($dataPO->PPNPersen > 0) echo number_format($dataPO->PPNPersen) . "%"; ?></strong></td>
                    <td style="text-align: right;"><?php echo number_format($dataPO->PPN); ?></td>
                </tr>
            <?php } ?>
            <tr>
                <td colspan="<?php echo $colspan; ?>" style="text-align: right;"><strong>GRAND TOTAL</strong></td>
            ...
            <td colspan="3" style="vertical-align: top;">
                <table width="100%">
                    <tr>
                        ...
                        <td width="10">:</td>
                        <td><?php if ($dataPO->InvPembayaran != "") echo nl2br($dataPO->InvPembayaran);
                            else echo "-"; ?></td>
                    </tr>
                    <tr>
                        <td><strong>Bank</strong></td>
                        <td>:</td>
                        <td><?php if ($dataPO->InvBank != "") echo $dataPO->InvBank;
                            else echo "-"; ?></td>
                    </tr>
                    <tr>
                        <td><strong>Delivery</strong></td>
                        <td>:</td>
                        <td><?php if ($dataPO->InvDelivery != "") echo $dataPO->InvDelivery;
                            else echo "-"; ?></td>
                    </tr>
                    <tr>
                        <td><strong>Expedisi</strong></td>
                        <td>:</td>
                        <td><?php if ($dataPO->InvExpedisi != "") echo $dataPO->InvExpedisi;
                            else echo "-"; ?></td>
                    </tr>
                    <tr>
                        <td><strong>Alamat Pengiriman</strong></td>
                        <td>:</td>
                        <td><?php if ($dataPO->InvAlamatPengiriman != "") echo $dataPO->InvAlamatPengiriman;
                            else echo "-"; ?></td>
                    </tr>
                </table>
            </td>
