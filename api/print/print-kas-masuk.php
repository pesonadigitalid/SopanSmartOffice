...
$invoice = $db->get_row("SELECT * FROM tb_kas_masuk WHERE IDKasMasuk='$id'");
...
<html>
    ...
    <body>
        <table>
            <tr>
                ...
                <td width="40%" align="center" class="title-kwitansi">
                    <h2 style="font-size: 20px !important;letter-spacing: 0px;margin-top: 40px;">BUKTI KAS MASUK</h2>
                </td>
        ...
        <div class="data-container-kwitansi">
            <table>
                <tr>
                    <td style="width: 120px !important;"><p><span class="n-divider">Diterima dari:</span><span><em><strong>Recieved from</strong></em></span></p></td>
