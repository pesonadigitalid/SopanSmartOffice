...
if($kategori){
    $cond .= " AND Kategori='$kategori'";
    $subtitle = "<strong>Kategori</strong> : ".$kategori;
} else {
    $subtitle = "<strong>Kategori</strong> : Semua Kategori";
}
...
<html>
    ...
    <body>
        ...
        <div class="laporanTitle">
            <h1 class="underline">** LAPORAN PENJUALAN PERKATEGORI (SPB) **</h1><?php echo $subtitle; ?>
        </div>
        <table class="tabelList2" cellpadding="0" cellspacing="0">
            ...
            <tbody>
                ...
                ?>
                <tr class="highlight2">
                    <td colspan='4' style="text-align: right;"><strong>TOTAL NILAI PENJUALAN : </strong></td>
