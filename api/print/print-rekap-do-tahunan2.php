...
<body class="center">
    <h1 class="blue newPage">Rekap DO Tahunan</h1>
    ...
    <table class="tbLabaRugi" style="width: auto">
        <thead>
            <tr>
                ...
                <td style="text-align: right;font-weight: bold;border-bottom: solid 1px #333;padding-bottom: 5px;width:100px;" class="red">Stok Gudang</td>
                <td style="text-align: right;font-weight: bold;border-bottom: solid 1px #333;padding-bottom: 5px;width:100px;" class="red">Stok Purchasing</td>
                <td style="text-align: right;font-weight: bold;border-bottom: solid 1px #333;padding-bottom: 5px;width:100px;" class="red">Total DO</td>
            </tr>
            <tr>
        ...
        <tbody>
            ...
            for ($i = 1; $i <= 12; $i++) {
                ...
                $qPengiriman = newQuery("get_results", "SELECT NoPengiriman FROM tb_pengiriman WHERE DATE_FORMAT(Tanggal,'%Y-%m')='$tahun-$bul'");
                ...
                $TotalPOBulananPajak = newQuery("get_var", "SELECT SUM(SubTotal) FROM tb_pengiriman_detail WHERE NoPengiriman IN ('$NoPengiriman') AND StokFrom='0'");
                if (!$TotalPOBulananPajak) $TotalPOBulananPajak = 0;
                $TotalPOBulananNonPajak = newQuery("get_var", "SELECT SUM(SubTotal) FROM tb_pengiriman_detail WHERE NoPengiriman IN ('$NoPengiriman') AND StokFrom='1'");
