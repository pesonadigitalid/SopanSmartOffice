...
<body class="center">
    <h1 class="blue newPage">Rekap Retur Tahunan</h1>
    ...
    <table class="tbLabaRugi" style="width: auto">
        <thead>
            <tr>
                ...
                <td style="text-align: right;font-weight: bold;border-bottom: solid 1px #333;padding-bottom: 5px;width:100px;" class="red">Total Retur</td>
            </tr>
            <tr>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    <td style="font-weight: bold;" class="red"><?php echo $bulan[$bul]; ?></td>
                    <td style="text-align: right;font-weight: bold;border-bottom: solid 1px #333;padding-bottom: 5px;padding-top: 5px;"><?php echo number_format($total, 2); ?></td>
                </tr>
            <?php
            }
            ?>
