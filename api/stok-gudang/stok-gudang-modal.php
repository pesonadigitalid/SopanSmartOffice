...
$query = $db->get_results("SELECT *, DATE_FORMAT(DateCreated,'%d/%m/%Y') AS TanggalID FROM tb_kartu_stok_gudang WHERE IDBarang='$id' AND IDGudang='$gudang' ORDER BY IDKartuStok ASC");
$StokAkhir = 0;
$HPPAkhir = 0;
if ($query) {
    $return = array();
